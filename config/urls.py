...
from life.users.reset_password_views import ResetPasswordConfirm, ResetPasswordRequestToken

schema_view = get_schema_view(
    openapi.Info(
        title="Life API",
        default_version="v1",
        description="Api Documentation for Life",
...
urlpatterns = [
    ...
    # User management
    # path("users/", include("life.users.urls", namespace="users")),
    # path("accounts/", include("allauth.urls")),
    # path("facility/", include("life.facility.urls", namespace="facility")),
    # RESTful APIs
