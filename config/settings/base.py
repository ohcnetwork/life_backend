...
ROOT_DIR = environ.Path(__file__) - 3  # (life/config/settings/base.py - 3 = life/)
APPS_DIR = ROOT_DIR.path("life")
...
LOCAL_APPS = ["life.users.apps.UsersConfig", "life.app"]
...
MIGRATION_MODULES = {"sites": "life.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "life.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "life.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "life.users.adapters.SocialAccountAdapter"
...
DEFAULT_FROM_EMAIL = env("EMAIL_FROM", default="Coronasafe network <life@coronasafe.network>")
